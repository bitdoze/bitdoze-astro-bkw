...
description: "Learn how to deploy a node.js static website Astro on a VPS server easely."
...
You can check also this tutorial is showing how you can deploy Astro on your VPS with a Heroko or Netlify alternative Coolify: [Coolify Install A Free Heroku and Netlify Self-Hosted Alternative](https://www.bitdoze.com/coolify-install-heroku-alternative/)
...
## Deploy Astro.JS on Your Own VPS With CloudPanel
...
After you need go and edit the root directory to point to **www.domain.com/dist** the dist directory is used by Astro to deploy the static content when you build it. Check the below picture:
