...
[NocoDB](https://nocodb.com/) and [Baserow](https://baserow.io/) are open-source alternatives to Airtable, providing flexible database and spreadsheet functionality.
