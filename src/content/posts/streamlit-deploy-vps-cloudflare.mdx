...
### 4. Get the Streamlit App on VPS.
...
mkdir /opt/streamlit-app && cd /opt/streamlit-app
...
### 5. Install the requirements for your app
...
And then use the following command to install them:

```sh
pip3 install -r requirements.txt
```

### 6. Run the app on your VPS
...
### 7.Set up PM2 to manage your streamlit app
...
```sh
pm2 start 'streamlit run /opt/streamlit-app/repo-name/app.py' --name my-streamlit-app
```
...
### 8. Create a Cloudflare tunnel and install Cloudflared on your VPS
