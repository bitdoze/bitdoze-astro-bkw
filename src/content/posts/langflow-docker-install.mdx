...
- VPS where you can host LangFlow, you can use one from [Hetzner](https://go.bitdoze.com/hetzner)
...
services:
  ...
  langflow:
    ...
    depends_on:
      - langflow-db
    environment:
      LANGFLOW_DATABASE_URL: postgresql://${POSTGRES_USER}:${POSTGRES_PASSWORD}@langflow-db:5432/langflow?sslmode=disable
