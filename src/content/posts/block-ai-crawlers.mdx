...
title: "How to Block AI Crawler Bots"
...
In the Free WAF you have 3 rules that can be used and you can create 1 just for this. To activate it go to **Security - WAF** and hit create a new Rule. In there you need to set:
