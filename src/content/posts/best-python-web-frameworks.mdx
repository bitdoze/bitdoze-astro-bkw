...
description: "A complete list with the "
...
- **[NiceGui](https://nicegui.io/)**: A user interface framework that allows you to create beautiful and responsive web applications with Python only **[NiceGui Repo](https://github.com/zauberzeug/nicegui)**. You can check also [Streamlit vs. NiceGUI](https://www.bitdoze.com/streamlit-vs-nicegui/) for an in-depth comparison.
