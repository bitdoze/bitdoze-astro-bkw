...
description: "Learn how you can deploy Filebrowser with the help of Docker to manage your server files with a UI"
...
- VPS where you can host FlowiseAI, you can use one from [Hetzner](https://go.bitdoze.com/hetzner)
