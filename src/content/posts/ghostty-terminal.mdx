...
You can [download Ghosttly](https://ghostty.org/download) as a package on your Mac or you can install it with homebrew with:
...
- Sets the font family to MesloLGS Nerd Font Mono. To list the fonts that are available in ghosttly you can run the bellow command:
  ```sh
  ghostty +list-fonts
  ```
- Changes the font size to 19
- Sets the background opacity to 0.9 (90% opaque)
- Applies the Argonaut color theme. To list the themes that are available in ghosttly you can run the bellow command:
  ```sh
  ghostty +list-themes
  ```
