...
> For servers that provides only hosting like Hetzner, Vultr, DigitalOcean or Hostinger VPS you will need an hosting panal to help you manage your PHP projects. The recommandations are [CloudPanel](https://www.cloudpanel.io/) and [Ploi.io](https://ploi.io/).
